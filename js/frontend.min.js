...
"use strict";
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([[325], {
    1553: (e, t) => {
    ...
    2176: (e, t) => {
        ...
        t.default = elementorModules.frontend.handlers.Base.extend({
            ...
            onSuccess(e) {
                ...
                if (this.elements.$submitButton.removeAttr("disabled").find(".elementor-form-spinner").remove(),
                t.animate({
                    opacity: "1"
                ...
                e.success) {
                    ...
                    elementorFrontendConfig.experimentalFeatures.e_font_icon_svg && (s += " elementor-message-svg"),
                    void 0 !== e.data.message && "" !== e.data.message && t.append('<div class="' + s + '" role="alert">' + e.data.message + "</div>")
                } else
                    e.data.errors && (jQuery.each(e.data.errors, (function(e, s) {
